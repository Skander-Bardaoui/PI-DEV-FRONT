    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
      <div className="bg-white rounded-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-4" noValidate>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className={inputCls(errors.invoice_date?.message)}
              />
              <Err msg={errors.invoice_date?.message} />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Échéance <span className="text-gray-400 text-xs">(auto si vide)</span>
              </label>
              <input
                type="date"
                {...register('due_date')}
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                ...
                <input
                  ...
                  className={inputCls(errors.subtotal_ht?.message) + ' text-right'}
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={inputCls(errors.tax_amount?.message) + ' text-right'}
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={inputCls(errors.timbre_fiscal?.message) + ' text-right'}
                />
          ...
          {/* FONCTIONNALITÉ 2 : UploadInvoiceScan remplace <input type="url"> */}
          <div>
